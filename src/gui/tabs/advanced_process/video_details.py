...
class VideoDetailsWidget(QFrame):
    ...
    def init_ui(self):
        ...
        self.combo_video.setItemDelegate(RichTextDelegate())
        ...
        self.combo_audio.setItemDelegate(RichTextDelegate())
        ...
        self.combo_audio_source.setItemDelegate(RichTextDelegate())
